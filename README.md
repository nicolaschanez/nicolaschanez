# Salut 👋, je suis Nicolas Chanez

## Développeur Full Stack (ou Étudiant Développeur)

Je suis un étudiant en **Informatique (Bac+3)** **passionné** par l'**Algorithmie** et le **Développement**. Je **crée** donc diverses **applications**, **notamment** en rapport avec le jeu vidéo.
...
* La gestion de la mémoire et des structures de données avancées.
* La gestion de **bases** de données **complètes**.
...
| :--- | :--- |
| **Langages Cœurs** | C++, Python |
| **Spé. Moteur** | Unity, Godot |
...
* **Email :** nicolaschanez42@gmail.com
